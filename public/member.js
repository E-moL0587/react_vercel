...
function displayMembers(members) {
  ...
  members.forEach(function(member) {
    ...
    if (members === members2) {
      var memberFlexContainer = document.createElement("div");
      memberFlexContainer.className = "member-flex-container";

      var photoPara = document.createElement("img");
      photoPara.src = member.photo;
      memberFlexContainer.appendChild(photoPara);

      memberDiv.appendChild(memberFlexContainer);
    } else {
...
button.addEventListener("click", toggleMembers);
